...
export const routes: Routes = [
    { 
        ...
        component: PagesComponent, children: [
            ...
            { path: 'inicio', loadChildren: './pages/inicio/inicio.module#InicioModule', data: { breadcrumb: 'Inicio' } },
            { path: 'nosotros', loadChildren: './pages/about/about.module#AboutModule', data: { breadcrumb: 'Home' } },
            { path: 'power', loadChildren: './pages/power/power.module#PowerModule', data: { breadcrumb: 'Power' } },
            { path: 'contacto', loadChildren: './pages/contacto/contacto.module#ContactoModule', data: { breadcrumb: 'Contacto' } },
            { path: 'users', loadChildren: './pages/users/users.module#UsersModule', data: { breadcrumb: 'Users' } },

            { path: 'desarrollo-software', loadChildren: './pages/servicios/dds/dds.module#DdsModule', data: { breadcrumb: 'Desarrollo de Software' } },
